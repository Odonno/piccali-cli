        ...
        <div className="flex flex-col gap-1 p-3 flex-1 overflow-hidden">
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="flex items-center gap-2 px-2 py-1.5 rounded">
              ...
              <Skeleton className="h-3.5" style={{ width: `${55 + (i % 3) * 18}%` }} />
            </div>
          ))}
        </div>
      </aside>
          ...
          <div className="max-w-3xl mx-auto flex flex-col gap-6">
            ...
            <div className="flex flex-col items-center justify-center gap-4 py-24 text-muted-foreground">
              ...
              <div className="flex flex-col items-center gap-1.5">
                <p className="text-sm font-medium text-foreground">Loading features...</p>
                <p className="text-xs text-muted-foreground">Parsing Gherkin feature files</p>
              </div>
